...
export type HotReloadableResource = Omit<V1Deployment | V1DaemonSet | V1StatefulSet, "status">
...
export function configureHotReload({
  ...
  // We use this to check whether the target is configured for hot-reloading.
  set(target, ["metadata", "annotations", "garden.io/hotReload"], "true")
